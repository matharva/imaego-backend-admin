...
// API service
import { getTalent, changeSequence } from '../services/talentService';
...
const ChangeTalentSequence = () => {
    ...
    return (
        <div>
            ...
            {console.log("Player Details from 78", playerDetails)}
                        ...
                        {(provided, snapshot) => (
                            ...
                            {/* <div className="droppable" > */}
                                ...
                                {sequence.map((player, index) => {
                                    const currentPlayer = playerDetails.filter(item => player.sequence === item.sequence)[0]
...
export default ChangeTalentSequence
